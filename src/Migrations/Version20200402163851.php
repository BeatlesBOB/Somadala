 ...
 */
final class Version20200402163851 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE panier (id INT AUTO_INCREMENT NOT NULL, client_id_id INT DEFAULT NULL, quantite INT NOT NULL, UNIQUE INDEX UNIQ_24CC0DF2DC2902E0 (client_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE panier ADD CONSTRAINT FK_24CC0DF2DC2902E0 FOREIGN KEY (client_id_id) REFERENCES client (id)');
